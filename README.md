...
<p align="center">
  <img src="screenshots/gameplay_hero.png" alt="OpenFifa Gameplay - Night Stadium" width="720"/>
  <br/>
  <em>Rush mode: 4v4 night match with broadcast HUD, stadium floodlights, and FIFA-style controls</em>
</p>
...
| Date | Update |
|------|--------|
| **2026-03-02** | Rush mode playable! Night stadium, broadcast HUD, 3D goal nets, minimap radar. 680+ tests pass. |
...
| Feature | Status |
|---------|--------|
| 5v5 arcade matches (4v4 Rush mode) | **Done** |
| AI opponents with FSM behavior | **Done** |
| FIFA-style keyboard/mouse controls | **Done** |
| Broadcast-style camera | **Done** |
| Match flow (kickoff, halftime, fulltime) | **Done** |
| Goal celebrations + replays | Planned |
| Team selection + formations | Planned |
| Sound effects + crowd audio | Planned |
| AAA gameplay optimized for macOS (60fps, <200MB, controller rumble) | In Progress |
...
> The game is playable with 680+ automated tests passing.
...
3. **Open `Assets/Scenes/Match.unity`** and press **Play**
   - The `MatchOrchestrator` auto-bootstraps everything: pitch, players, ball, goals, camera, HUD
   - Move with **WASD**, sprint with **Shift**, pass with **Space**, shoot with **F**
   - Switch players with **Q**, tackle with **E**
4. **Full game flow**: Kickoff → First half (3 min) → Halftime → Second half → Fulltime
...
```
Phase 1: Foundation        [US-001 — US-008]  ██████████  100%
Phase 2: Core Gameplay     [US-009 — US-018]  ██████████  100%
Phase 3: Game Feel         [US-019 — US-027]  ██████████  100%
Phase 4: UI & Menus        [US-028 — US-035]  ██████████  100%
Phase 5: Polish & Platform  [US-036 — US-043]  ██████████  100%
Phase 6: Asset Integration [US-044 — US-050]  ██████████  100%
